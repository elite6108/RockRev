/*
  # Add Fire Action Plan and Related Columns to RAMS Table

  1. New Columns
    - `fire_action_plan` (text) - For storing fire action plan details
    - `protection_of_public` (text) - For storing public protection measures
...
ADD COLUMN IF NOT EXISTS protection_of_public text,
