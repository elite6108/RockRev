...
export function ShortQuestionnaire({ isOpen, onClose, userEmail, onScanQRCode }: ShortQuestionnaireProps) {
  ...
  const [lastQuestionnaireId, setLastQuestionnaireId] = useState<string | null>(null);
  const qrScannerRef = useRef<Html5QrcodeScanner | null>(null);
  const [showScanner, setShowScanner] = useState(false);
  
  useEffect(() => {
    if (showQRScanner && !scannedSiteId && showScanner) {
      // Initialize QR scanner with mobile-friendly settings
  ...
  }, [showQRScanner, scannedSiteId, showScanner]);
  ...
  const handleNext = () => {
    if (currentStep === 1) {
      ...
      if (!formData.fitToWork || !formData.takingMedications || !formData.wearingCorrectPPE) {
        setError("Please answer all questions before proceeding.");
        return;
      }
      
      // Check if any answers prevent proceeding
      if (formData.fitToWork === 'no' || formData.takingMedications === 'yes' || formData.wearingCorrectPPE === 'no') {
        setError("Based on your responses, you may not be fit to work. Please contact your supervisor.");
        return;
      }
      ...
      if (!hasSignature) {
        setError("Please sign the declaration before proceeding.");
        return;
      }
              ...
              <div>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-medium text-gray-500 dark:text-gray-400">
                      {currentStep === 1 ? 'Fit to Work' : currentStep === 2 ? 'Declaration' : 'Site Check-in'}
                    </span>
                  </div>
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                        <p className="font-medium text-gray-800 dark:text-gray-200 mb-3">
                          Have you taken any drugs/medications that could impair safety?
                        </p>
                        <div className="flex justify-center space-x-4">
                          <button
                            type="button"
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                      <div className="text-sm text-gray-700 dark:text-gray-300 mb-4">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                          <li>I am fit to work and have not knowingly withheld any information</li>
                          <li>I will comply with all site safety rules and procedures</li>
                          <li>I will report any accidents, incidents, or safety concerns immediately</li>
                        </ul>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                        {scannedSiteId ? (
                          ...
                          <>
                            <div className="mb-4">
                              <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Scan Site QR Code</h5>
                              <p className="text-gray-700 dark:text-gray-300 mb-2">
                                Please allow camera access when prompted to scan the site QR code.
                              </p>
                            </div>
                            ...
                            <div className="mt-4 text-center">
                              <p className="text-sm text-gray-600 dark:text-gray-400">
                                The QR code should be located at the site entrance or provided by your supervisor
                              </p>
                            </div>
                          </>
                        )}
              ...
              <>
                ...
                {currentStep === 3 ? (
                  <button
                    ...
                    disabled={loading || !scannedSiteId}
