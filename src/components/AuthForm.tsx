  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // When signing up
        if (userType === 'staff') {
          // Validate domain and token against tokens table
          ...
          if (tokenError || !tokenData) {
            throw new Error('You have entered an incorrect domain and/or token combination. Please try again.');
          }
        }
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleAuth}>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    required
                    className="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                    placeholder="Domain without www (e.g. example.com)"
                    value={domain}
          ...
          <p>After you sign up, you will receive an email with a link to verify your account.</p>
