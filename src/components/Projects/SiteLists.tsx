...
export function SiteLists({ onBack }: SiteListsProps) {
  ...
  const downloadQRCode = async (site: Site) => {
    try {
      ...
      // Update to create a URL for the check-in form within the main app
      const appURL = `${window.location.origin}/check-in?site_id=${site.id}`;
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search by site name, address, manager..."
