...
import { ChevronLeft, Plus, Edit, Trash2, AlertTriangle, FileText, Loader2, Search, ChevronUp, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-white mb-6">
        ...
        <span>/</span>
        <span className="text-gray-900 dark:text-white font-medium">Risk Assessments</span>
      </div>
