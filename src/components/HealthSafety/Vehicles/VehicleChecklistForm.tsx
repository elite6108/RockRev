...
import type { Vehicle, ChecklistItem, VehicleChecklist } from '../../../types/database';
...
export default function VehicleChecklistForm({ vehicle, checklistToEdit, onClose, onSuccess }: VehicleChecklistFormProps) {
  ...
  useEffect(() => {
    if (checklistToEdit) {
      setItems(checklistToEdit.items);
        ...
        <div className="sticky top-0 bg-white z-10 p-4 sm:p-8 border-b">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
            <h2 className="text-2xl font-bold text-center sm:text-left">
              {checklistToEdit ? 'Edit Vehicle Checklist' : 'New Vehicle Checklist'}
            </h2>
            <button
              onClick={onClose}
                    ...
                    <div key={item.id} className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-start bg-gray-50 p-4 rounded-lg">
                      <div className="sm:col-span-4">
                        ...
                        >
                          ...
                          {item.name && !getAvailableItems().outsideItems.includes(item.name) && 
                           !getAvailableItems().insideItems.includes(item.name) && (
