  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (checklistToEdit) {
        ...
        ({ error } = await supabase.from('equipment_checklists').insert([
          {
                  ...
                  >
                    <div className="col-span-1 sm:col-span-4">
                      ...
                      >
                        ...
                        {item.name &&
                          !getAvailableItems().includes(item.name) && (
                              ...
                              <div className="relative group">
                                ...
                                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity rounded">
                                  <button
                                    type="button"
                                    onClick={() =>
                                      handleItemChange(item.id, 'image_url', '')
                                    }
