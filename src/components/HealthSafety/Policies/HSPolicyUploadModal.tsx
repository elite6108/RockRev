...
interface HSPolicyUploadModalProps {
  onClose: () => void;
  onSuccess: () => void;
}
...
export function HSPolicyUploadModal({ onClose, onSuccess }: HSPolicyUploadModalProps) {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
      <div className="relative bg-white rounded-lg shadow-xl p-8 max-w-md w-full m-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Upload Health & Safety Policy PDFs</h2>
          <button
            onClick={onClose}
